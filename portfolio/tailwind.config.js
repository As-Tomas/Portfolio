...
export default {
  ...
  theme: {
    extend: {
      boxShadow: {
        neon_purple: "0 0 5px theme('colors.purple.200'), 0 0 10px theme('colors.purple.700')",
      ...
      backgroundImage: {
        'radial-shadow': 'radial-gradient(circle, rgba(255, 255, 255, 0.6) 1%, transparent 75%)',
      },
