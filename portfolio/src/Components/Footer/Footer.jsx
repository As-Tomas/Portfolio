  ...
  return (
    <div className="group relative overflow-hidden">
      <footer className=" z-20 fixed bottom-0  w-full mx-auto text-white text-lg sm:text-xl bg-[rgba(255,255,255,0.2)] backdrop-blur-md border-t-2 rounded-t-2xl border-[rgba(255,255,255,0.3)] ">
        <section className="max-w-4xl  mx-auto px-2  sm:p-4 flex flex-row items-center justify-between">
      ...
      <div
        className=" z-10 fixed bottom-0 h-14 sm:h-28  w-full overflow-hidden before:bottom-0 before:absolute before:left-[-100%] rounded-t-2xl  
      before:w-full before:h-14 before:sm:h-28 before:content-'' before:bg-gradient-to-r before:transform  before:from-transparent before:via-[rgba(255,255,255,0.3)]
