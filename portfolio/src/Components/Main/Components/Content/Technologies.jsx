...
const Technologies = () => {
  ...
  return (
    <section id='technologies' className='p-6 text-center scroll-mt-20 h-full w-full overflow-y-auto  '>
      <h2 className='text-3xl font-bold mb-6 text-slate-900 '>Known Technologies</h2>
      ...
      <ul className='list-none mx-auto my-12 flex flex-wrap justify-center gap-8'>
        <li className='flex-1 flex flex-col items-center border border-solid  bg-gradient-to-br from-inherit to-inherit  py-6 px-2 rounded-2xl shadow-xl'>
          <img src='./assets/GeneralIcons/cloud-technology.png' alt='Infinity' className='w-1/5 ' />
          <h3 className='text-xl font-medium text-slate-900  underline decoration-4 decoration-indigo-500'>Android, iOS platforms App Development</h3>
          <p className='hidden sm:block text-lg mt-2 text-slate-500 -400'>Skilled in developing hybrid mobile apps and cross-platform solutions using the Expo SDK, .NET MAUI, Android Studio frameworks.</p>
          <p className=' text-base mt-2 text-slate-500 -400'>Platform specific App Development.</p>
        </li>
        <li
          className='flex-1 flex flex-col items-center border border-solid bg-gradient-to-br from-inherit to-inherit 
         py-6 px-2 rounded-2xl shadow-xl'>
          <img src='./assets/GeneralIcons/software-developer.png' alt='Android' className='w-1/5 ' />
          <h3 className='text-xl font-medium text-slate-900  underline decoration-4 decoration-sky-500'>Software Development</h3>
          <p className='hidden sm:block text-lg mt-2 text-slate-500 -400'>
            Experienced in both functional and OOP: <br></br> C++, Java, Python, programing languages.
          </p>
          <p className=' text-base mt-2 text-slate-500 -400'>Software App dev.</p>
        </li>
        <li className='flex-1 flex flex-col items-center border border-solid  bg-gradient-to-br from-inherit to-inherit  py-6 px-2 rounded-2xl shadow-xl'>
          <img src='./assets/GeneralIcons/front-end.png' alt='Node.Js' className='w-1/5 ' />
          <h3 className='text-xl font-medium text-slate-900  underline decoration-4 decoration-pink-500'>Frontend Development </h3>
          <p className='hidden sm:block text-lg mt-2 text-slate-500 -400'>Experienced development in HTML, CSS, JS and React framework.</p>
          <p className=' text-base mt-2 text-slate-500 -400'>Frontend App dev.</p>
        </li>
      </ul>
      <hr className='mx-auto my-10 bg-black  w-1/2'></hr>
      <div id='tools' className='p-5 flex flex-col  gap-4 border border-solid bg-gradient-to-br from-inherit to-inherit rounded-2xl shadow-xl'>
        ...
        <div>
          ...
          <div className='pb-10 lg:mx-20 xl:mx-32 2xl:mx-40 flex flex-wrap justify-center gap-4'>
            <img className='w-14 h-14 lg:w-20 lg:h-20 p-2 bg-gradient-to-br from-[#ffffffa6] to-[#ffffff54] rounded hover:scale-125 transition shadow' src='./assets/cursor.png' alt='Cursor' />
        ...
        <div ref={thisIsVisible}>
          ...
          <div className='pb-10 flex flex-wrap justify-center gap-4'>
            ...
            <div className='w-14 h-14 lg:w-20 lg:h-20 p-2 bg-gradient-to-br from-[#ffffffa6] to-[#ffffff54] rounded hover:scale-125 transition shadow flex items-center justify-center '>
              <svg viewBox='0 0 71 20' fill='none' role='img' className='icon-md w-[64px]  ' title='Expo home'>
                <path
