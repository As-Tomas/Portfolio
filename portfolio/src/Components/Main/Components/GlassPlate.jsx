  ...
  },
  {
    ...
    icon: (
      <svg xmlns='http://www.w3.org/2000/svg' height='1.3rem' viewBox='0 0 512 512'>
        <path fill='currentColor' d='M500.3 237.1l-192-160A24 24 0 0 0 272 64H64c-35.3 0-64 28.7-64 64V384c0 35.3 28.7 64 64 64H272a24 24 0 0 0 36.3-13.1l192-160a24 24 0 0 0 0-37.8zM288 400H64c-8.8 0-16-7.2-16-16V128c0-8.8 7.2-16 16-16H288V400zM352 334.2 288 384V128l64 49.8V334.2z' />
      </svg>
    ),
  },
  {
          ...
          <aside className='flex w-full flex-col gap-4 md:gap-5'>
            ...
            <nav className='flex flex-col gap-1.5 md:gap-2 text-[0.7rem] md:text-sm' aria-label='Profile navigation'>
              {navItems.map(item => (
                ...
                >
                  <span className='text-white h-4 w-4 md:h-5 md:w-5 [&>svg]:h-full [&>svg]:w-full'>{item.icon}</span>
              ...
              <a href='https://no.linkedin.com/in/tomas-bancevicius' target='_blank' rel='noreferrer'>
                <button className='flex w-full items-center justify-between rounded-2xl border border-white/15 bg-white/8 px-3 md:px-4 py-2.5 md:py-3 text-white/70 transition-colors hover:text-white hover:bg-white/15'>
                  ...
                  <span className='text-white/60'>
                    <svg className='pl-[2px]' xmlns='http://www.w3.org/2000/svg' height='0.9rem' viewBox='0 0 60 60' fill='#5a5a5c'>
