  ...
  return (
    ...
    >
      <div className="container h-[75vh]  w-[90vw] max-w-[1400px]  ">
        <div
          className="card h-[73vh]  max-w-[90vw] backdrop-blur-2xl  
          rounded-2xl before:rounded-2xl before:block before:absolute bg-gradient-to-br from-[rgba(177,227,225,0.3)] to-[rgba(255,255,255,0.7)]  "
        ...
        >
          ...
          >
            <div
              className="dashboard px-1 max-w-xs  sm:px-10 lg:px-20 flex-1 flex flex-col items-center justify-evenly  
              space-y-10 text-base lg:text-lg  rounded-2xl before:rounded-2xl before:block before:absolute
            ...
            >
              ...
              <div className="links flex flex-col">
                ...
                <a
                  href="https://no.linkedin.com/in/tomas-bancevicius"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className={`flex whitespace-nowrap rounded-lg py-1 px-2 `}>
                    <div className="mr-2">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        height="1.5rem"
                ...
                <a
                  href="https://github.com/As-Tomas"
                  target="_blank"
                  rel="noreferrer"
                >
                  <button className={`flex whitespace-nowrap rounded-lg py-1 px-2 `}>
