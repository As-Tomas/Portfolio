...
const GlassPlate = () => {
  ...
  return (
    <div
      className="body-card-div h-full w-full flex flex-grow items-center justify-center "
      ...
      <div className="container min-h-[70vh] h-full w-full  flex justify-center items-center ">
        ...
        >
          ...
          >
            ...
            >
              <div className="user mx-3 flex flex-col items-center justify-evenly ">
                <img
                  src={avatar}
                  alt="Tomas Bance"
              ...
              <div className="links flex flex-col">
                ...
                >
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 576 512">
                ...
                >                  
                  <div className="mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 640 512">
                ...
                >
                  <div className="mr-2">
                  <svg xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 576 512">
                  <path d="M160 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h50.7L9.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L256 109.3V160c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H160zM576 80a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM448 208a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM400 384a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm48 80a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zm128 0a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM272 384a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm48 80a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zM144 512a48 48 0 1 0 0-96 48 48 0 1 0 0 96zM576 336a48 48 0 1 0 -96 0 48 48 0 1 0 96 0zm-48-80a48 48 0 1 0 0-96 48 48 0 1 0 0 96z"/></svg>
                  </div>
                  <h2>My Skills</h2>
                </button>
              ...
              >
                <div className="mr-2">
                <svg xmlns="http://www.w3.org/2000/svg" height="1.5rem" viewBox="0 0 512 512">
                  <path d="M176 56V96H336V56c0-4.4-3.6-8-8-8H184c-4.4 0-8 3.6-8 8zM128 96V56c0-30.9 25.1-56 56-56H328c30.9 0 56 25.1 56 56V96v32V480H128V128 96zM64 96H96V480H64c-35.3 0-64-28.7-64-64V160c0-35.3 28.7-64 64-64zM448 480H416V96h32c35.3 0 64 28.7 64 64V416c0 35.3-28.7 64-64 64z"/></svg>
