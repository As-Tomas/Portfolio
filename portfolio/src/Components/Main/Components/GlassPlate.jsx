          ...
          <aside className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://no.linkedin.com/in/tomas-bancevicius" target="_blank" rel="noreferrer">
                <button className="flex w-full items-center justify-between rounded-2xl border border-white/15 bg-white/8 px-4 py-3 text-white transition-colors hover:bg-white/15">
                  <span className="flex items-center gap-3 text-base font-medium">
              ...
              <button
                className="flex items-center gap-3 rounded-2xl border border-white/15 bg-white/8 px-4 py-3 text-left text-white transition-colors hover:bg-white/15"
