...
const GlassPlate = ({ setContent }) => {
  ...
  const isActive = component => (activeComponent === component ? 'underline decoration-4 decoration-pink-500 ' : '');
        ...
        >
          <section
            ...
            <div
              ...
              space-y-6  text-base lg:text-lg  rounded-2xl before:rounded-2xl before:block before:absolute
              ...
              <div className=' mx-auto flex flex-col items-center justify-evenly '>
                <img src={avatar} alt='Tomas Bance' className=' w-2/3 h-3/9  rounded-lg ' />
                <h3 className=' font-bold'> Tomas Bance</h3>
                <h4 className='text-center '>Full-Stack Developer</h4>
              </div>

              <div className='links flex flex-col'>
                <button className={`flex whitespace-nowrap rounded-lg py-1 px-2 ${isActive('AboutMe')}`} onClick={() => toggleComponent('AboutMe')}>
                  <div className='mr-2 '>
                ...
                <button className={`flex whitespace-nowrap rounded-lg py-1 px-2 ${isActive('MyPath')}`} onClick={() => toggleComponent('MyPath')}>
                  <div className='mr-2 '>
                    <svg xmlns='http://www.w3.org/2000/svg' height='1.4rem' viewBox='0 0 640 512'>
                ...
                <button className={`flex whitespace-nowrap rounded-lg py-1 px-2 ${isActive('Technologies')}`} onClick={() => toggleComponent('Technologies')}>
                  <div className='mr-2'>
                    <svg xmlns='http://www.w3.org/2000/svg' height='1.4rem' viewBox='0 0 640 512'>
                ...
                <div className='divide-y divide-solid divide-slate-500'></div>
                ...
                <a href='https://v1.scrimba.com/certificate/uQyMggf3/gaiengineer' target='_blank' rel='noreferrer'>
                  <button className={`flex whitespace-nowrap rounded-lg py-1 px-2 `}>
                    <div className='mr-2 '>
                      <svg xmlns='http://www.w3.org/2000/svg' height='1.3rem' viewBox='0 0 145 100'>
              ...
              <button className={`flex whitespace-nowrap rounded-lg py-1 px-2 pt-4 `} onClick={() => setContent('projects')}>
                <div className='mr-2 '>
                  <img style={{ height: '1.8rem' }} src={'assets/GeneralIcons/projects-icon.svg'} alt='Logo' />
                </div>

                <h2 className='text-lg font-semibold'>Projects</h2>
              </button>

              <button className={` hidden flex whitespace-nowrap rounded-lg py-1 px-2 ${isActive('ContactMe')}`} onClick={() => toggleComponent('ContactMe')}>
                <div className='mr-2'>
